 ...
 * <ul>
 *   <li>启用 {@link ImageProperties} 作为配置载体。</li>
 *   <li>按条件导入 {@link GMConfiguration} 与 {@link ImageIOConfiguration} 两个子配置。</li>
 * </ul>
 *
 * <p><strong>生效条件</strong></p>
 * <ul>
 *   <li>GM：需要配置 {@code pangju.image.gm.path} 且类型为 {@code GM}。</li>
