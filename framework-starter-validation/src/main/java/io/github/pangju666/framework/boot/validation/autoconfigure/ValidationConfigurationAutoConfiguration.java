...
package io.github.pangju666.framework.boot.validation.autoconfigure;
 ...
 * @since 1.0.0
 */
@AutoConfiguration(before = org.springframework.boot.validation.autoconfigure.ValidationAutoConfiguration.class)
