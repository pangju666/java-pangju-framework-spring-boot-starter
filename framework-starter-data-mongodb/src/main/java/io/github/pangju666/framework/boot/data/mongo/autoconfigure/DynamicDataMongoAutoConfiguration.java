 ...
 * <ul>
 *   <li>启用 {@link DynamicDataMongoProperties} 属性绑定。</li>
 *   <li>导入 {@link DynamicDataMongoRegistrar}，在启动阶段按数据源动态注册连接相关 Bean。</li>
 ...
 * @since 1.0.0
 */
@AutoConfiguration(before = {MongoAutoConfiguration.class, DataMongoAutoConfiguration.class})
@ConditionalOnClass({MongoClient.class, MongoTemplate.class, GridFsTemplate.class})
@EnableConfigurationProperties({DynamicDataMongoProperties.class})
@Import(DynamicDataMongoRegistrar.class)
public class DynamicDataMongoAutoConfiguration {
	/**
	 * 注册 Mongo 管理类型 Bean。
	 *
