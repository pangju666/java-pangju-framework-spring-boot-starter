 ...
 *   <li>导入 {@link io.github.pangju666.framework.boot.autoconfigure.data.dynamic.mongo.DynamicMongoRepositoriesRegistrar}，按数据源生成仓库相关 Bean 定义。</li>
 * </ul>
 *
 ...
 *   <li>满足 {@link io.github.pangju666.framework.boot.autoconfigure.data.dynamic.mongo.OnDynamicMongoCondition} 条件（动态数据源配置有效）。</li>
 * </ul>
 *
 * <p><strong>顺序</strong></p>
 * <ul>
 *   <li>在 {@link MongoRepositoriesAutoConfiguration} 之前、{@link DynamicDataMongoAutoConfiguration} 之后执行。</li>
 * </ul>
 *
 ...
 *
 * @author pangju666
 * @see io.github.pangju666.framework.boot.autoconfigure.data.dynamic.mongo.DynamicMongoRepositoriesRegistrar
 * @see io.github.pangju666.framework.boot.autoconfigure.data.dynamic.mongo.OnDynamicMongoCondition
 * @since 1.0.0
 */
@AutoConfiguration(before = DataMongoRepositoriesAutoConfiguration.class, after = DynamicDataMongoAutoConfiguration.class)
...
public class DynamicDataMongoRepositoriesAutoConfiguration {
}
