 ...
 * @since 1.0.0
 */
@ConfigurationProperties(prefix = DynamicDataMongoProperties.PREFIX)
public class DynamicDataMongoProperties {
	/**
	 * 配置属性前缀
	 *
	 * @since 1.0.0
	 */
	public static final String PREFIX = "spring.mongodb.dynamic";
	...
	public static class MongoProperties extends org.springframework.boot.mongodb.autoconfigure.MongoProperties {
		private DataMongoProperties data = new DataMongoProperties();

		public DataMongoProperties getData() {
			return data;
		}

		public void setData(DataMongoProperties data) {
			this.data = data;
		}
	}
}
