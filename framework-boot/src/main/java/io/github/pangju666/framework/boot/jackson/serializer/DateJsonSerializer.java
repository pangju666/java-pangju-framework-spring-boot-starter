 ...
 * Date 类型的 JSON 序列化器。
 * <p>
 * 将 {@link Date} 转换为 JSON 中的毫秒时间戳（数值）。
 ...
 * @since 1.0.0
 */
public final class DateJsonSerializer extends JsonSerializer<Date> {
    /**
     * 将 {@link Date} 序列化为 JSON 中的毫秒时间戳。
     * <p>
     * 行为：当值非空时写出 {@link Date#getTime()} 的数值；当值为空时写出 JSON null。
     * </p>
     *
     * @param value       要序列化的 {@link Date}
