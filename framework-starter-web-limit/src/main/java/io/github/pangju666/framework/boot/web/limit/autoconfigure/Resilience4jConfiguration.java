...
package io.github.pangju666.framework.boot.web.limit.autoconfigure;

import io.github.pangju666.framework.boot.web.limit.RateLimiter;
import io.github.pangju666.framework.boot.web.limit.Resilience4JRateLimiter;
 ...
 * <ul>
 *   <li>类路径存在 {@code io.github.resilience4j.ratelimiter.RateLimiter}（{@link ConditionalOnClass}）。</li>
 *   <li>配置属性 {@code pangju.web.rate-limit.type = RESILIENCE4J} 或未指定（{@link ConditionalOnProperty}）。</li>
 *   <li>容器中不存在其他 {@link RateLimiter} Bean（{@link ConditionalOnMissingBean}）。</li>
 * </ul>
 *
