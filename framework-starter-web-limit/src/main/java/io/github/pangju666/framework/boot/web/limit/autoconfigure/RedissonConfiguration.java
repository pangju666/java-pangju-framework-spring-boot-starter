...
import io.github.pangju666.framework.boot.web.limit.RedissonRateLimiter;
 ...
 * <ul>
 *   <li>类路径存在 {@link RedissonClient}（{@link ConditionalOnClass}）。</li>
 *   <li>配置属性 {@code pangju.web.rate-limit.type = REDISSON}（{@link ConditionalOnProperty}）。</li>
