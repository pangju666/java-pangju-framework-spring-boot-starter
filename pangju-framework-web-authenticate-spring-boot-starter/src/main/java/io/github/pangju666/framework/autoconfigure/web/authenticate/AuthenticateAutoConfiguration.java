...
public class AuthenticateAutoConfiguration {
	...
	@ConditionalOnExpression("#{environment['chang-tech.web.authenticate.algorithm'] == null || T(io.github.pangju666.framework.autoconfigure.web.authenticate.enums.Algorithm).AES.name().equals(environment['chang-tech.web.authenticate.algorithm'].toUpperCase()) || T(io.github.pangju666.framework.autoconfigure.web.authenticate.enums.Algorithm).RSA.name().equals(environment['chang-tech.web.authenticate.algorithm'].toUpperCase())}")
	@Bean
