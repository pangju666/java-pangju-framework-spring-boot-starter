 ...
 * @since 1.0.0
 */
@ConfigurationProperties(prefix = DynamicDataRedisProperties.PREFIX)
public class DynamicDataRedisProperties {
	/**
	 * 配置属性前缀
	 *
	 * @since 1.0.0
	 ...
	 * @since 1.0.0
	 */
	private Map<String, DataRedisProperties> databases;

	public Map<String, DataRedisProperties> getDatabases() {
		return databases;
	}

	public void setDatabases(Map<String, DataRedisProperties> databases) {
