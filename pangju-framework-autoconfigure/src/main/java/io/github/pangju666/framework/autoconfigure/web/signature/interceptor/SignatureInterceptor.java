 ...
 *     <li>从 {@link SignatureProperties} 配置中获取签名字段名称，支持灵活自定义。</li>
 ...
 *     <li>结合 {@link io.github.pangju666.framework.autoconfigure.web.signature.annotation.Signature} 注解在控制器实现细粒度校验。</li>
 * </ul>
 *
 * <p>签名校验步骤：</p>
 * <ol>
...
public class SignatureInterceptor extends BaseHttpInterceptor {
	 ...
	 * 配置由 {@link SignatureProperties} 提供，支持灵活的自定义配置。
	 * </p>
	 *
	 * @see SignatureProperties
	 * @since 1.0.0
	 ...
	 * 构造函数，初始化拦截器。
	 * <p>
	 * 通过注入 {@link SignatureProperties} 配置和密钥存储器 {@link SignatureSecretKeyStorer}，
	 * 构建签名校验拦截器实例。
	 * </p>
	 *
	 * @param properties 签名相关配置类，定义如签名字段名称及位置等信息。
