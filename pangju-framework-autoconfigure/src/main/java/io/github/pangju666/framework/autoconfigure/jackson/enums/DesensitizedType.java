 ...
 * <p>
 * 该枚举类用于在{@link io.github.pangju666.framework.autoconfigure.jackson.annotation.DesensitizeFormat}注解中
 * 指定需要应用的脱敏策略类型。不同的脱敏类型对应不同的脱敏处理逻辑。
 * </p>
 *
 * @author pangju666
 * @see io.github.pangju666.framework.autoconfigure.jackson.annotation.DesensitizeFormat
 * @see io.github.pangju666.framework.autoconfigure.jackson.serializer.DesensitizedJsonSerializer
 * @since 1.0.0
 */
public enum DesensitizedType {
	 ...
	 * 自定义脱敏类型
	 * <p>
	 * 当选择此类型时，需要通过{@link io.github.pangju666.framework.autoconfigure.jackson.annotation.DesensitizeFormat}
