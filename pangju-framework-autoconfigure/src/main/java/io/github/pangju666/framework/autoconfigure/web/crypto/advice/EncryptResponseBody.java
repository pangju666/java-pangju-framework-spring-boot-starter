 ...
 * 响应体加密注解
 * <p>
 * 该注解用于标记Spring MVC控制器方法，指示框架应在序列化HTTP响应体时
 * 对其进行加密处理。注解需配合{@link ResponseBodyEncryptAdvice}使用，
 ...
 *     <li>{@link ResponseBodyEncryptAdvice}拦截响应在序列化前</li>
